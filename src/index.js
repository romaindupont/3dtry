...
/* 	camera.lookAt(0, 0, 1) */
  ...
  scene.background = new THREE.Color(0xedeeef);
...
/*   renderer.toneMapping = THREE.ACESFilmicToneMapping;
  ...
  const camera = new THREE.PerspectiveCamera(50, window.innerWidth / window.innerHeight, 0.1, 1500);
	...
	camera.position.set(-800, 800/* -800 */, 100 );
/* 	camera.lookAt(0, 0, 1) */
  const controls = new OrbitControls(camera, container);
  controls.target.set(50, 0, 0);
  controls.minDistance = 100;
...
/* 	const Racing = new THREE.MeshPhysicalMaterial({
	...
	mtlLoader.load("../src/assets/3d/untitled.mtl", function(object)
	{    
		object.preload();
...
/* 	loader.setMaterials(object); */
	/* loader.setLibraryPath( 'https://cdn.jsdelivr.net/npm/rhino3dm@0.15.0-beta/' ); */
  loader.load('../src/assets/3d/untitled.obj', function (gltf) {
		const carModel = gltf;
		/* carModel.scene.children[0].children[0].children[8].children[0].material = glassMaterial; */
